...
```{r echo=F}
# to do: add A, B, C booleans, calculate x, y, value, source from that + 'AND' function
# think about including the 'AND' function in the data. Means I need a list? or a class?
datAND <- data.frame(
...
xp <- xyplot(y ~ x,
  data=datAND,
  panel = function(y, x, ...) {
    ltext(x = x, y = y, labels = datAND$source, cex = 1, font = 2,
...
xp <- xyplot(
  ...
  data=datOR,
  panel = function(y, x, ...) {
    ltext(x = x, y = y, labels = datOR$source, cex = 1, font = 2,
      fontfamily = "HersheySans")
  }
  )
...
xp <- xyplot(
  ...
  data=datXOR,
  panel = function(y, x, ...) {
    ltext(x = x, y = y, labels = datXOR$source, cex = 1, font = 2,
      fontfamily = "HersheySans")
  }
  )
